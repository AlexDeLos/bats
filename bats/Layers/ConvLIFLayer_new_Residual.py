...
class ConvLIFLayer_new_Residual(AbstractConvLayer):
    ...
    def forward(self, max_simulation: float, training: bool = False) -> None:
        ...
        print("pre ins: "+ cp.where(pre_n_spike_per_neuron != 0))
        print("Jump ins: "+ cp.where(jump_n_spike_per_neuron != 0))
        ...
        print("combined ins: "+ cp.where(pre_n_spike_per_neuron_pre_pad != 0))
        ...
        # Now we pad both the pre_spike_per_neuron and the pre_n_spike_per_neuron
            ...
            print("after padding: "+ cp.where(pre_n_spike_per_neuron != 0))
        ...
        if sorted_indices.size == 0:  # No input spike in the batch
            ...
            print("sorted indices: "+ cp.where(sorted_spike_indices != 0))
