...
SAVE_DIR = Path("/fashion/"+str(N_HIDDEN_LAYERS)+"_"+ str(neuron_var['n_neurons'])+"_"+str(neuron_out_var['n_neurons'])+"_"+str(neuron_res_var['n_neurons'])+"_"+str(USE_RESIDUAL)+"_"+str(RESIDUAL_EVERY_N)+"_"+str(RESIDUAL_JUMP_LENGTH)+"_"+str(FUSE_FUNCTION)+"_"+str(USE_DELAY)+"_"+str(TTFS)+"_"+str(CLUSTER))
