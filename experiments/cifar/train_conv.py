...
if arguments.learning_rate is not None:
    ...
    LEARNING_RATE = 0.0001#arguments.learning_rate
...
SAVE_DIR = Path("/cifar/"+str(N_HIDDEN_LAYERS)+"_"+ str(str(conv_var['filter']))+"_"+str(output_var['n_neurons'])+"_"+str(str(conv_var['filter']))+ str(USE_RESIDUAL)+str(RESIDUAL_EVERY_N)+str(RESIDUAL_JUMP_LENGTH)+str(USE_PADDING)+ '_'+str(conv_var['spike_buffer_size'])+'_'+str(conv_res_var['spike_buffer_size']))
