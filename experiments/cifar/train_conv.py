...
SAVE_DIR = Path("/cifar/"+str(N_HIDDEN_LAYERS)+"_"+str(conv_var['filter'])+"_"+str(conv_var['threshold_hat'])+"_"+str(conv_var['spike_buffer_size'])+"_"+str(conv_res_var['filter'])+"_"+str(conv_res_var['threshold_hat'])+"_"+str(conv_res_var['spike_buffer_size'])+'_'+str(USE_PADDING)+'_'+ str(arguments.fuse_func))
