...
SAVE_DIR = Path("/mnist/"+str(N_HIDDEN_LAYERS)+"_"+ str(conv_var)+"_"+str(output_var)+"_"+str(conv_res_var)+'_'+ str(USE_RESIDUAL)+'_'+str(RESIDUAL_EVERY_N)+'_'+str(RESIDUAL_JUMP_LENGTH)+'_'+str(USE_PADDING)+'_'+str(TARGET_FALSE)+'_'+str(TARGET_FALSE)+'-'+ str(USE_DELAY)+ '_'+ str(arguments.fuse_func))
