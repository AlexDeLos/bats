...
FILTER_1_5 = np.array([5, 5, 40])
TAU_S_1_5 = 0.130
THRESHOLD_HAT_1_5 = 0.04
DELTA_THRESHOLD_1_5 = 1 * THRESHOLD_HAT_1_5
SPIKE_BUFFER_SIZE_1_5 = 1

FILTER_2 = np.array([5, 5, 40]) # used to be [5,5,40]
TAU_S_2 = 0.130
THRESHOLD_HAT_2 = 0.8
...
for run in range(NUMBER_OF_RUNS):
    ...
    conv_1_5 = ConvLIFLayer(previous_layer=conv_1, filters_shape=FILTER_1_5, tau_s=TAU_S_1_5,
    ...
    #! there is a problem if one input is a pool layer and the other a conv layer
    conv_2 = ConvLIFLayerResidual(previous_layer=conv_1_5, jump_layer= conv_1_5, filters_shape=FILTER_2, tau_s=TAU_S_2,
    # *I can connect it straight to other conv layers
    # conv_2 = ConvLIFLayer(previous_layer=conv_1_5, filters_shape=FILTER_2, tau_s=TAU_S_2,
...
#         name="Residual-SNN_conv_"+ str(FUSE_FUNCTION)+"_run_"+str(run),
...
#         "version": "1.0.0_conv_cluster_" + str(CLUSTER),
#         }
#         )
