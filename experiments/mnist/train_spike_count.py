...
SAVE_DIR = Path("/mnist/"+str(N_HIDDEN_LAYERS)+"_"+ str(neuron_var['n_neurons'])+"_"+str(neuron_out_var['n_neurons'])+"_"+str(neuron_res_var['n_neurons'])+"_"+str(USE_RESIDUAL)+"_"+str(RESIDUAL_EVERY_N)+"_"+str(RESIDUAL_JUMP_LENGTH)+"_"+str(FUSE_FUNCTION)+"_"+str(USE_DELAY)+"_"+str(TTFS)+"_"+str(CLUSTER))
...
for run in range(NUMBER_OF_RUNS):
    ...
    if USE_WANDB:
        w_b = wandb_handler("Final_thesis_testing", "MNIST_MLP_run_"+str(run),
        {"Cluster": CLUSTER,
