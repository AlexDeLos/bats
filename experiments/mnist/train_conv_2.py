...
FILTER_1 = np.array([5, 5, 4])
TAU_S_1 = 0.130
THRESHOLD_HAT_1 = 0.04
DELTA_THRESHOLD_1 = 1 * THRESHOLD_HAT_1
SPIKE_BUFFER_SIZE_1 = 1

FILTER_2 = np.array([3, 3, 4])
TAU_S_2 = 0.130
THRESHOLD_HAT_2 = 0.8
DELTA_THRESHOLD_2 = 1 * THRESHOLD_HAT_2
SPIKE_BUFFER_SIZE_2 = 3

FILTER_3 = np.array([3, 3, 4])
TAU_S_3 = 0.130
THRESHOLD_HAT_3 = 0.8
DELTA_THRESHOLD_3 = 1 * THRESHOLD_HAT_3
SPIKE_BUFFER_SIZE_3 = 3
...
#! is the nans an architecture problem?
        # conv_3 = ConvLIFLayer(previous_layer=pool_2, filters_shape=np.array([5, 5, 8]), use_padding=USE_PADDING,
        #                 #   filter_from_next = FILTER_FROM_NEXT,
        #                     tau_s=TAU_S_1,
        #                     theta=THRESHOLD_HAT_1,
        #                     delta_theta=DELTA_THRESHOLD_1,
